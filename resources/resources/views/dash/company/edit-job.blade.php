                            ...
                            <div class="job_filter_category_sidebar pd0 jb_cover">
                                ...
                                <div class="job_overview_header jb_cover">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="contect_form3">
                                                <label>@lang('dash/company.CandidateStudy')</label>
                                                <select name="study">
                                                  @if(old('study'))
                                                      <option value="{{old('study')}}">{{old('study')}}</option>
                                                  @else
                                                   <option value="">@lang('dash/company.ChooseStudyLevel')</option>
                                                 @endif
                                                   <option value="Fresher">@lang('dash/company.NoStudy')</option>
