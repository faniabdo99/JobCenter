                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-5 col-md-5 col-12 col-sm-12">
                        <div class="sub_title_section">
                            <ul class="sub_title">
                                <li> <a href="#">
                                        @lang('dash/company.Home') </a>&nbsp; / &nbsp; </li>
                                <li>
                                    @lang('dash/company.PostNewJob')</li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="job_overview_header jb_cover">
                                        <div class="row">
                                                    ...
                                                    <label>
                                                        @lang('dash/company.JobCategory')</label>
                                                            <select name="category_id" required>
                                                                @if(old('category_id'))
                                                                <option selected value="{{old('category_id')}}">
                                                                    @lang('dash/company.JobCategory')</option>
                                                                        @else
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="contect_form3">
                                                    <label>
                                                        @lang('dash/company.CandidateStudy')</label>
                                                            <select name="study">
                                                                @if(old('study'))
                                                                <option value="{{old('study')}}">{{old('study')}}</option>
                                                                @else
                                                                <option value="">
                                                                    @lang('dash/company.ChooseStudyLevel')</option>
                                                                        @endif
                                                                <option value="Fresher">
                                                                    @lang('dash/company.NoStudy')</option>
                                                                <option value="Junior">
