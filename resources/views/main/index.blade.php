...
<body>
    ...
    <div class="jb_banner_wrapper jb_cover">
        <div class="jb_banner_left">
            <h1>
                @lang('main/index.IndexTopH')</h1>
                    <p>
                        @lang('main/index.IndexTopP')</p>
                            @php
                            ...
                            <form action="{{route('search')}}" method="get">
                                ...
                                <div class="select_box select_box_2">
                                    ...
                                    <select name="category">
                                        <option value="">
                                            @lang('layout/parts.Category')</option>
                                ...
                                <div class="select_box">
                                    ...
                                    <select name="type">
                                        <option value="">
                                            @lang('layout/parts.JobType')</option>
                                        <option value="full">
                                            @lang('layout/parts.FullTime')</option>
                                        <option value="part">
                                            @lang('layout/parts.PartTime')</option>
                                        <option value="rotation">
                                            @lang('layout/parts.Rotation')</option>
                                        <option value="temporary">
                                            @lang('layout/parts.Temporary')</option>
                                    </select>
                                </div>
                                <div class="header_btn search_btn jb_cover">
                                    <button type="submit"><i class="fas fa-search"></i>
                                        @lang('layout/parts.Search')</button>
                                </div>
                            </form>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="jb_heading_wraper">
                        <h3>
                            @lang('main/index.IndexBrowseByCategoryH')</h3>
                                <p>
                                    @lang('main/index.IndexBrowseByCategoryP')</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="jb_browse_category jb_cover">
                        <a href="{{route('search' , ['category' , $Category->id])}}">
                            ...
                            <p>({{count($Category->Jobs)}}
                                @lang('layout/parts.Jobs'))</p>
                        </a>
                    </div>
                </div>
                @empty
                <p>
                    @lang('layout/parts.NoData')</p>
                        @endforelse
            </div>
        </div>
        <div class="header_btn search_btn load_btn jb_cover">
            <a href="{{route('categories')}}">
                @lang('layout/parts.Categories')</a>
        </div>
    </div>
    </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12 col-sm-12">
                    ...
                    <div class="grow_next_text jb_cover">
                        ...
                        <div class="header_btn search_btn jb_cover">
                            <a href="{{route('about')}}">
                                @lang('layout/parts.DiscoverMore')</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-12 col-sm-12">
                    ...
                    <div class="latest_job_overlow jb_cover">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="latest_job_toper jb_cover">
                                <h1>
                                    @lang('layout/parts.LatestJobs')</h1>
                            </div>
                        </div>
                                ...
                                <div id="home" class="tab-pane active">
                                    ...
                                    <div class="latest_job_box jb_cover">
                                        ...
                                        @if($Job->Salary)
                                            <div class="job_list_next">
                                                <p>{{$Job->Salary}}
                                                    @lang('layout/parts.IQD') / @lang('layout/parts.Month')</p>
                                            </div>
                                            @endif
                                    </div>
                                    @empty
                                    <p>
                                        @lang('layout/parts.NoData')</p>
                                            @endforelse
                                            <span class="se_all_job"><a href="{{route('jobs')}}">
                                                    @lang('layout/parts.ViewAllJobs') <i class="fas fa-long-arrow-alt-right"></i></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="jb_heading_wraper">
                        <h3>
                            @lang('main/index.IndexFromBlogH')</h3>
                                <p>
                                    @lang('main/index.IndexFromBlogP')</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="blog_newsleeter jb_cover">
                        <h1>
                            @lang('main/index.IndexFeedbackH')</h1>
                                <p>
                                    @lang('main/index.IndexFeedbackP')</p>
                                        <form action="{{route('contact.quick')}}" method="post">
                                            ...
                                            <div class="header_btn search_btn submit_btn jb_cover">
                                                <button type="submit">
                                                    @lang('layout/forms.Submit')</button>
                                            </div>
                                        </form>
                    </div>
                </div>
                                            ...
                                            @lang('main/index.IndexFAQ')</h1>
                                                    ...
                                                    <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="heading1" data-parent="#accordion" style="">
                                                        <div class="card-body">
                                                            <div class="card_cntnt">
                                                                <p>يمكن اتباع الخطوات في هذا <a href="https://womenjobcenter.com/storage/app/public/inst/حساب_للموظف.pdf/"> الرابط</a></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div id="collapsefour" class="collapse" role="tabpanel" aria-labelledby="heading3" data-parent="#accordion" style="">
                                                        <div class="card-body">
                                                            <div class="card_cntnt">
                                                                <p>يمكن اتباع الخطوات في هذا <a href="https://womenjobcenter.com/storage/app/public/inst/حساب_للشركة.pdf/"> الرابط</a></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card">
                                                    ...
                                                    <div id="collapsefive" class="collapse" role="tabpanel" aria-labelledby="heading4" data-parent="#accordion" style="">
                                                        <div class="card-body">
                                                            <div class="card_cntnt">
                                                                <p>يمكن اتباع الخطوات في هذا <a href="https://womenjobcenter.com/storage/app/public/inst/نشر_وظيفة.pdf/"> الرابط</a></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
