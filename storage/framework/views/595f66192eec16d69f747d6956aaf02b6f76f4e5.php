<?php echo $__env->make('dash.layout.header' , ['PageTitle' => 'Edit Profile'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-12 col-sm-12">
                        <h1><?php echo app('translator')->get('dash/company.EdiProfile'); ?></h1>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\AppServ\www\jobcenter\resources\views/dash/company/edit.blade.php ENDPATH**/ ?>